package EventosXMLyJSON.EjemploXML;
...
/**public class Main {
    ...
    try {
        ...
        try {
            ...
            String usuario = document.getElementsByTagName("usuario").item()

            // Mostramos usuario y clave:
            System.out.println("Usuario: " + usuario + " Clave: " + clave);

            // Vamos a mostrar el atributo "proveedor"
            NamedNodeMap atributos = document.getElementsByTagName("videos").item(0).getChildNodes();
